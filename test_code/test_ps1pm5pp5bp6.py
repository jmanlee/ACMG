...
def clinvar_db_dic():
    ...
    clinvar_db_dic = {
        "CYP2C19": {"10-96521657-C-A": ["Benign/Likely benign", {"-": 1}, "-"]},
        "LOC110599570": {"10-96521657-C-A": ["drug response", {"-": 1}, "-"]},
        "OAT": {
            "10-126086520-C-G": [
                "Pathogenic",
                {
        ...
        "PLCE1": {
            ...
            "10-95892201-C-T": ["Pathogenic", {"nonsense": 3}, "R493*::R185*",],
        },
        "ECEL1": {
            "2-233344913-A-G": [
                "Pathogenic/Likely pathogenic",
            ...
            "2-233344914-C-G": [
                "Pathogenic/Likely pathogenic",
                {"splice donor variant": 5, "missense variant": 8},
                "C758R::C760R",
            ],
            "2-233344915-T-G": [
                "Pathogenic/Likely pathogenic",
                {"initiatior codon variant": 2},
                "C758R::C760R",
            ],
        },
        "Gene1": {
        ...
        "Gene3": {
            ...
            "10-50678369-T-A": ["Benign", {"missense variant": 4}, "R1213G",],
        },
    }

    return clinvar_db_dic
...
@pytest.mark.parametrize(
    "var_infos, gene_symbol, expected",
    [
        (
            [
                "11-76853783-T-C",
...
def test_check_amino_acid_change_in_clinvar(
    var_infos,
    gene_symbol,
    expected,
    df_col2idx,
    ...
    assert expected == check_amino_acid_change_in_clinvar(
        var_infos, df_col2idx, clinvar_db_dic[gene_symbol], clinvar_col2idx
    )


@pytest.mark.parametrize(
    "var_id, gene_symbol, expected",
    [
        ("10-96521657-C-A", "CYP2C19", (0, 1)),
        ("10-126086520-C-G", "OAT", (1, 0)),
        ("10-126086518-C-G", "OAT", (0, 0)),
        ("10-126086520-C-G", "some gene", (0, 0)),
        ("10-96014013-C-T", "PLCE1", (1, 0)),
        ("10-96014013-C-T", "ECEL", (0, 0)),
    ],
)
def test_check_same_variant_in_clinvar(
    var_id, gene_symbol, expected, clinvar_db_dic, clinvar_col2idx
):

    assert expected == check_same_variant_in_clinvar(
...
def check_amino_acid_change_in_clinvar(
    ...
    Args:
        proband_var_infos (list): proband_variant information list
