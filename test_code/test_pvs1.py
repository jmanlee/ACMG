        ...
        (
            {
                "var_infos": [
                    ...
                    "ENSG00000237298",
                    "ENST00000591332",
                    "intron_variant,non_coding_transcript_variant,stop_retained_variant",
                    "-",
                    "-",
                    "-",
                    "-",
...
def test_is_null_var(var_infos_dic, expected, df_col2idx):

    assert expected == is_null_var(var_infos_dic, df_col2idx)
...
def clinvar_db_dic():
    ...
    clinvar_db_dic = {
        ...
        "ECEL1": {
            ...
            "2-233344914-C-G": [
                "Pathogenic/Likely pathogenic",
                {"splice donor variant": 5, "missense variant": 3},
                "C758R::C760R",
            ],
            "2-233344915-T-G": [
                "Pathogenic/Likely pathogenic",
...
def test_check_disease_cause_is_null(gene_symbol, expected, clinvar_db_dic):
    ...
    assert expected == check_disease_cause_is_null(
